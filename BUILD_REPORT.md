...
| A07 | ID & Auth Failures        | PARTIAL — email+password + Argon2id + lockout + account-existence oracle defense done; MFA + email verification deferred per Master Spec §2 (compensating controls listed)             |
